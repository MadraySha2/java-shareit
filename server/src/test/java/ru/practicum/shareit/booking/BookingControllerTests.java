...
public class BookingControllerTests {
    ...
    public void testAddBooking() throws Exception {
        ...
        BookingDto bookingResponse = BookingDto.builder().id(1L).item(Item.builder().id(1L).build()).booker(User.builder().id(1L).build()).status(Status.WAITING).build();
    ...
    public void testGetAllBookingByState() throws Exception {
        ...
        when(bookingService.getAllBookingByState(anyLong(), anyString(), anyInt(), anyInt())).thenReturn(bookingList);
    ...
    public void testGetAllBookingByState_InvalidPageFrom() throws Exception {
        ...
        int from = -1;
        int size = 10;
        when(bookingService.getAllBookingByState(anyLong(), anyString(), anyInt(), anyInt())).thenThrow(new ValidationException(""));
    ...
    public void testGetAllBookingByState_InvalidUserId() throws Exception {
        ...
        when(bookingService.getAllBookingByState(anyLong(), anyString(), anyInt(), anyInt())).thenThrow(new NotFoundException("User not found."));
    ...
    public void testGetAllItemsBookings() throws Exception {
        ...
        when(bookingService.getAllOwnersBookingByState(anyLong(), anyString(), anyInt(), anyInt())).thenReturn(bookingList);
    ...
    public void testGetAllItemsBookings_InvalidUserId() throws Exception {
        ...
        when(bookingService.getAllOwnersBookingByState(anyLong(), anyString(), anyInt(), anyInt())).thenThrow(new NotFoundException("User not found."));
    ...
    public void testGetAllItemsBookings_InvalidPageFrom() throws Exception {
        ...
        when(bookingService.getAllOwnersBookingByState(anyLong(), anyString(), anyInt(), anyInt())).thenThrow(new ValidationException(""));
