...
class BookingMapperTest {
    ...
    @Test
    void toBooking() {
        BookingDto bookingDto = BookingDto.builder().id(1L).item(Item.builder().id(1L).build()).booker(User.builder().id(1L).build()).start(LocalDateTime.now()).end(LocalDateTime.now().plusHours(2)).status(Status.WAITING).build();
