...
public class BookingControllerTests {
    ...
    public void testAddBooking() throws Exception {
        ...
        Long userId = 1L;
        BookingEntryDto bookingDto = BookingEntryDto.builder().id(1L)
                .itemId(1L).start(LocalDateTime.now().plusHours(1)).end(LocalDateTime.now().plusHours(2)).build();
        BookingDto bookingResponse = BookingDto.builder()
                .id(1L).item(Item.builder().id(1L).build()).booker(User.builder().id(1L).build()).status(Status.WAITING).build();
    ...
    public void testGetAllBookingByState_InvalidUserId() throws Exception {
        ...
        when(bookingService
                .getAllBookingByState(anyLong(), anyString(), ArgumentMatchers.any(PageRequest.class)))
